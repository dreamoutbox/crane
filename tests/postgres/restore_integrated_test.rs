...
fn test_restore_integrated_workflow() {
    ...
    run_sql(&interactor, "INSERT INTO integrated_test_table VALUES (1);");

    println!("Step 3: insert 2 to integrated_test_table");
    run_sql(&interactor, "INSERT INTO integrated_test_table VALUES (2);");
    ...
    // ============================================================
    // PREPARE DATA FOR PITR RESTORE
    // ============================================================
    println!("Step 9: insert 3 to table");
    let pitr_time_insert_3 = run_sql(
        &interactor,
        "INSERT INTO integrated_test_table VALUES (3) RETURNING to_char(clock_timestamp() + interval '1 second', 'YYYY-MM-DD HH24:MI:SS');",
    );
    ...
    // ============================================================
    // RESTORE FROM INCREMENTAL BACKUP TEST #1
    // ============================================================
    println!(
    ...
    // SIMULATE DATA LOSS
    // ============================================================
    println!("Step 17: delete integrated_test_table");
    run_sql(&interactor, "DROP TABLE integrated_test_table;");
    ...
    // ============================================================
    // RESTORE FROM INCREMENTAL BACKUP TEST #2
    // ============================================================
    println!(
...
pub fn run_sql(interactor: &Box<dyn ServerInteractor>, sql: &str) -> String {
...
//     "INSERT INTO integrated_test_table VALUES (5) RETURNING to_char(clock_timestamp(), 'YYYY-MM-DD HH24:MI:SS');",
// );
// let _pitr_time_insert_4 = pitr_time_insert_4
//     .lines()
//     .map(|s| s.trim())
//     .find(|s| s.len() == 19 && s.chars().nth(4) == Some('-') && s.chars().nth(13) == Some(':'))
//     .unwrap_or("")
